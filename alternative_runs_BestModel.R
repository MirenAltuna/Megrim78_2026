...
## Functions ----
reduce_pg_index <- function(ix, pg) {
...
# increase catch numbers likelihood weight in the fit
# WARNING: if you want to change this weight you need to create the stock object again
ctn <- catch.n(stk7)
ctn[] <- 0.5
